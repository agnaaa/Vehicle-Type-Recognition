...
# ===========================================================
    ...
    try:
        ...
        st.warning("⚠️ Foto pengembang tidak ditemukan. Pastikan file foto ada di folder yang sama dengan app.py.")

    if st.button("🤝 Tertarik Berkolaborasi? Hubungi Pengembang", use_container_width=True):
        webbrowser.open("https://wa.me/6289669727601", new_tab=True)
